...
import { 
  ...
  BackpackIcon as RadixBackpackIcon,
  FileTextIcon as RadixFileTextIcon,
  TwitterLogoIcon as RadixTwitterLogoIcon,
...
export const BackpackIcon = RadixBackpackIcon
export const FileTextIcon = RadixFileTextIcon
export const TwitterLogoIcon = RadixTwitterLogoIcon
